...
public class ShareVar {
	...
	public static String nowId="kim";
	public static String nowPw="";
	public static String userEmail="";
	public static String userName="간지gogo";
	public static String blindTime=null;
	public static String cloth="";

	public static int ProfileImg=0;
	public static int HatImg=0;
	public static int OuterImg=0;
	public static int TopImg=0;
	public static int BottomImg=0;
	public static int BagImg=0;
	public static int ShoesImg=0;
	public static int OnepieceImg=0;
