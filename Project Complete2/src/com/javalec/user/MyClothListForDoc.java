...
public  class MyClothListForDoc extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MyClothListForDoc window = new MyClothListForDoc();
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 687, 570);
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		frame.getContentPane().add(getLblmember());
		frame.getContentPane().add(getScrollPane_cth());
		frame.getContentPane().add(getBtnOK());
//		frame.getContentPane().add(getTextField()); // jy3 : 주석처리
//		frame.getContentPane().add(getBtnLoad_cth()); // jy3 : 주석처리
//		frame.getContentPane().add(getCbtitle_cth()); // jy3 : 주석처리
//		frame.getContentPane().add(getBtnMain()); // jy3 : 주석처리
