...
//----------------------------------------------------------------------------
	...
	public Bean(int wkSeq, String wkTitle, String wkContent, String wkusername, String wkaddtime, InputStream input,
			String wkUser_userid) {
		super();
		User_userid = wkUser_userid;
		this.username = wkusername;
		this.tablePK = wkSeq;
		this.content = wkContent;
		this.title = wkTitle;
		this.addtime = wkaddtime;
		this.clothimage = input;
	}
